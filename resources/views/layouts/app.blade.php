        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-6">
            ...
            <div class="md:col-span-1">
                <nav class="space-y-1 bg-white rounded-lg shadow p-4">
                    ...
                    <a href="{{ route('settings.subscription-plans') }}" class="block px-3 py-2 rounded-md {{ request()->routeIs('settings.subscription-plans') ? 'bg-purple-100 text-purple-900' : 'text-gray-600 hover:bg-gray-100' }}">Subscription Plans</a>
