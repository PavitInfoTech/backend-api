    ...
    <form action="{{ route('settings.update-auth') }}" method="POST" class="space-y-8">
            ...
            <div class="mt-4">
                ...
                <div class="space-y-2">
                    <div class="flex items-center">
                        <input type="text" readonly value="{{ url('/api/auth/google/callback') }}" class="w-full px-3 py-2 border border-gray-200 rounded-l-md bg-gray-50" id="google_callback_primary">
        ...
        <div class="border-t pt-6">
            ...
            <div class="mt-4">
                ...
                <div class="space-y-2">
                    <div class="flex items-center">
                        <input type="text" readonly value="{{ url('/api/auth/github/callback') }}" class="w-full px-3 py-2 border border-gray-200 rounded-l-md bg-gray-50" id="github_callback_primary">
